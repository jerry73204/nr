...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("builtinPath", "Built-in path: hexagonal, linear-y, zigzag, highway, urban-grid, kaohsiung", builtinPath);
    ...
    else if (mobilityModel == "waypoint")
    {
        ...
        else
        {
            ...
            {
                // Untested path. Not sure if it works yet.
                ...
                NS_LOG_INFO("Waypoint mobility: kaohsiung real-world path (speed="
