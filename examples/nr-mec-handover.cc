...
main(int argc, char* argv[])
{
    ...
    // Configure antennas - use smaller arrays for more omnidirectional coverage
    // This helps with handover by ensuring neighbor cells have comparable signal strength
